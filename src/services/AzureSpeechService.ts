  ...
  private initialize(): void {
    ...
    if (speechKey && speechRegion && speechKey !== 'your_azure_speech_key_here') {
      try {
        ...
        console.warn('⚠️ Azure Speech Service configuration failed, will use mock:', error);
        this.isConfigured = false;
      }
    } else {
      console.warn('⚠️ Azure Speech credentials not provided, will use mock transcription');
      this.isConfigured = false;
    }
  }
